    ...
    <section className="bg-ivory py-16 sm:py-24">
      <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-10">
        <article className="text-center">
          <BowAccent className="w-10 sm:w-12 h-5 sm:h-6 mx-auto mb-4 sm:mb-6 opacity-50" />
          <p className="font-sans text-[10px] sm:text-xs uppercase tracking-[0.4em] text-rose-gold mb-4 sm:mb-6">
            Our edit philosophy
          </p>
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-charcoal mb-8 sm:mb-10 leading-tight">
            We curate the prettiest, most useful things, so you don&rsquo;t have to scroll forever.
          </h2>
          <div className="font-serif text-base sm:text-lg lg:text-xl text-warm-gray leading-loose space-y-4 sm:space-y-6 italic">
            <p>
